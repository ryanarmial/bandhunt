...
<script>
  $(document).ready(function() {
    var table = $("#example1").DataTable({ "info": true,});

    $('#example1').on('click', 'ul.pagination', function () {

        $('.edit-song').click(function(){
          console.log('sini bung kesini');
          $(this).prev().removeAttr('disabled')
          $(this).hide();
          $(this).next().show();
        });
        $('.action-song .btn-danger').click(function() {
          $(this).parent().prev().prev().attr('disabled', '');
          $(this).parent().hide();
          $(this).parent().prev().show();
        });
        $('.action-song .btn-info').click(function() {
